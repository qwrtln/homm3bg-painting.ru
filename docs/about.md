...
Этот сайт не использует файлы cookie. Он был создан с использованием [Material for MkDocs](https://squidfunk.github.io/mkdocs-material/) и размещён на [GitHub Pages](https://pages.github.com/). Видео с непокрашенными миниатюрами взяты с [YouTube-канала Мэтью Райся](https://www.youtube.com/@agentsolorunthroughs6010).
